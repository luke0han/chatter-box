...
firebase.initializeApp({
  apiKey: "AIzaSyD29nDiKerxz5GKqCv37OkJ5wJjun0iUJI",
  authDomain: "chatterbox-9db57.firebaseapp.com",
  databaseURL:
    "https://chatterbox-9db57-default-rtdb.europe-west1.firebasedatabase.app",
  projectId: "chatterbox-9db57",
  storageBucket: "chatterbox-9db57.appspot.com",
  messagingSenderId: "569021756198",
  appId: "1:569021756198:web:a5e0ab0915a1584b14c7e7",
  measurementId: "G-M90MPGW967",
});
...
function App() {
 ...
 const [darkMode, setDarkMode] = useDarkMode();
  ...
  const renderContent = () => {
    ...
    return (
      <div className="bg-white dark:bg-black flex items-center justify-center shadow-md h-full">
        <div className="bg-white dark:bg-black flex flex-col items-center justify-center max-w-xl w-full mx-4 p-8 rounded-md shadow-card bg-white dark:bg-coolDark-600 transition-all">
          <h2 className="bg-white dark:bg-black mb-2 text-3xl flex items-center">
            <i className="bg-white dark:bg-black fas fa-comments"> </i>
            <span className="p-2">ChatterBox</span>
          </h2>
          <p className="mb-8 text-lg text-center">The secure messaging app</p>
          <button
            onClick={signInWithGoogle}
            className="rounded shadow-button pl-6 pr-8 py-3 bg-black shadow dark:bg-white dark:text-black dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-500 hover:bg-white hover:text-black text-white font-medium flex items-center justify-center overflow-y-hidden focus:outline-none focus:ring focus:ring-primary-500 focus:ring-opacity-75"
          >
            <svg
              viewBox="5 -5 30 30"
  ...
  return (
    <div className="bg-white dark:bg-black flex flex-col h-full bg-white dark:bg-coolDark-500 dark:text-white transition-colors">
      <header
        className="bg-white dark:bg-black flex-shrink-0 flex items-center justify-between px-4 sm:px-8 shadow-md"
        style={{ height: "var(--topbar-height)" }}
      >
        <i className="bg-white dark:bg-black fas fa-comments uppercase text-sm font-medium text-primary-500">
          {" ChatterBox"}
        ...
        <div className="flex items-center">
          ...
          <ThemeIcon
            className="bg-white dark:bg-black h-8 w-8 cursor-pointer"
